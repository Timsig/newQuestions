...
const CarBuild = () => (
  <Layout headerImage="https://res.cloudinary.com/lwcqviihu/image/upload/v1562762945/Question-set/Car-build-2-1.jpg">
    ...
    <Link to="/car1-assign">
      <Hotspot left={112} top={829} width={196} height={48} />
    </Link>
  </Layout>
)
